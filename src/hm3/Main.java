...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("кол-во добавлений элемента 5 = " + map.getCount(5));
        System.out.println("кол-во добавлений элемента 6 = " + map.getCount(6));
        System.out.println("кол-во добавлений элемента 10 = " + map.getCount(10));  // 3\\\

        System.out.println("кол-во добавлений элемента 5 до удаления = " + map.remove(5));
        System.out.println("кол-во добавлений элемента 5 до удаления = " + map.getCount(5));
